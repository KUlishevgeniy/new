...
def BuildCategroyCard(record: list) -> str:
    ...
    for path,directory,names in os.walk(os.path.join("."+os.sep +".."+os.sep,relIMG)):
      print(os.path.join("."+os.sep +".."+os.sep,relIMG))
      for file in names:
        if str(product_id) == file.split(".")[0]:
          img_path = os.path.join(relIMG,file)

    personal_page = os.path.join(relPPP, str(product_id) + ".html")
...
def BuildStaticProductPage(record: list) -> None:
    ...
    product_description = record[7]
    for path,directory,names in os.walk(os.path.join("."+os.sep +".."+os.sep,relIMG)):
      print(os.path.join("."+os.sep +".."+os.sep,PPPrelIMG))
      for file in names:
        if str(product_id) == file.split(".")[0]:
          img_path = os.path.join(PPPrelIMG,file)
...
<head>
  ...
  <link rel="icon" href="{PPPBF}/img/Fevicon.png" type="image/png">
  ...
  <link rel="stylesheet" href="{PPPBF}/css/style.css">
</head>
<body>
  <!--================ Start Header Menu Area =================-->
    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
          <a class="navbar-brand logo_h" href="index.html"><img src="{PPPBF}/img/logo.png" alt=""></a>
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              <li class="nav-item"><a class="nav-link" href="{PPPBF}/index.html">Домой</a></li>
              <li class="nav-item active submenu dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                  aria-expanded="false">Магазин</a>
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="{PPPBF}/category.html">Категории магазиновy</a></li>
                  <li class="nav-item"><a class="nav-link" href="{PPPBF}/single-product.html">Детали продукта</a></li>
                  <li class="nav-item"><a class="nav-link" href="{PPPBF}/checkout.html">Оформление</a></li>
                  <li class="nav-item"><a class="nav-link" href="{PPPBF}/confirmation.html">Подтверждение</a></li>
                  <li class="nav-item"><a class="nav-link" href="{PPPBF}/cart.html">Корзина</a></li>
                </ul>
              </li>
              <li class="nav-item submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="{PPPBF}/blog.html">Блог</a></li>
                  <li class="nav-item"><a class="nav-link" href="{PPPBF}/register.html">Регистрация</a></li>
                  <li class="nav-item"><a class="nav-link" href="{PPPBF}/single-blog.html">Детали</a></li>
                </ul>
              </li>
              <li class="nav-item submenu dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="{PPPBF}/login.html">Логин</a></li>
                  <li class="nav-item"><a class="nav-link" href="{PPPBF}/tracking-order.html">Отслеживание</a></li>
                </ul>
              </li>
            ...
            <div class="col-lg-6">
              <div class="comment_list">
                <div class="review_item">
                  <div class="media">
                    <div class="d-flex">
                      <img src="{PPPBF}/img/product/review-1.png" alt="">
                    </div>
                ...
                <div class="review_item">
                  <div class="media">
                    <div class="d-flex">
                      <img src="{PPPBF}/img/product/review-3.png" alt="">
                    </div>
                    <div class="media-body">
                      <h4>Blake Ruiz</h4>
                      <h5>12th Feb, 2018 at 05:56 pm</h5>
            ...
            <div class="col-lg-6">
              ...
              <div class="review_list">
                ...
                <div class="review_item">
                  <div class="media">
                    <div class="d-flex">
                      <img src="{PPPBF}/img/product/review-2.png" alt="">
                    </div>
                    <div class="media-body">
                      <h4>Blake Ruiz</h4>
                      <i class="fa fa-star"></i>
    ...
    <div class="container">
      ...
      <div class="row mt-30">
        <div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
          <div class="single-search-product-wrapper">
            <div class="single-search-product d-flex">
              <a href="#"><img src="{PPPBF}//img/product/product-sm-1.png" alt=""></a>
              <div class="desc">
            ...
            <div class="single-search-product d-flex">
              <a href="#"><img src="{PPPBF}//img/product/product-sm-2.png" alt=""></a>
              <div class="desc">
                <a href="#" class="title">Серая чашка для кофе</a>
                <div class="price">$170.00</div>
              </div>
            ...
            <div class="single-search-product d-flex">
              <a href="#"><img src="{PPPBF}//img/product/product-sm-3.png" alt=""></a>
              <div class="desc">
                <a href="#" class="title">Серая чашка для кофе</a>
                <div class="price">$170.00</div>
              </div>
        ...
        <div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
          <div class="single-search-product-wrapper">
            <div class="single-search-product d-flex">
              <a href="#"><img src="{PPPBF}/img/product/product-sm-4.png" alt=""></a>
              <div class="desc">
                  <a href="#" class="title">Серая чашка для кофе</a>
                  <div class="price">$170.00</div>
              </div>
            ...
            <div class="single-search-product d-flex">
              <a href="#"><img src="{PPPBF}/img/product/product-sm-5.png" alt=""></a>
              <div class="desc">
                <a href="#" class="title">Серая чашка для кофе</a>
                <div class="price">$170.00</div>
              </div>
            ...
            <div class="single-search-product d-flex">
              <a href="#"><img src="{PPPBF}/img/product/product-sm-6.png" alt=""></a>
              <div class="desc">
                <a href="#" class="title">Серая чашка для кофе</a>
                <div class="price">$170.00</div>
              </div>
        ...
        <div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
          <div class="single-search-product-wrapper">
            <div class="single-search-product d-flex">
              <a href="#"><img src="{PPPBF}/img/product/product-sm-7.png" alt=""></a>
              <div class="desc">
                  <a href="#" class="title">Серая чашка для кофе</a>
                  <div class="price">$170.00</div>
              </div>
            ...
            <div class="single-search-product d-flex">
              <a href="#"><img src="{PPPBF}/img/product/product-sm-9.png" alt=""></a>
              <div class="desc">
                <a href="#" class="title">Серая чашка для кофе</a>
                <div class="price">$170.00</div>
              </div>
          ...
          <div class="col-lg-2 col-md-6 col-sm-6">
            <div class="single-footer-widget instafeed">
              ...
              <ul class="list instafeed d-flex flex-wrap">
                <li><img src="{PPPBF}/img/gallery/r1.jpg" alt=""></li>
                <li><img src="{PPPBF}//img/gallery/r2.jpg" alt=""></li>
                <li><img src="{PPPBF}/img/gallery/r3.jpg" alt=""></li>
                <li><img src="{PPPBF}/img/gallery/r5.jpg" alt=""></li>
                <li><img src="{PPPBF}/img/gallery/r7.jpg" alt=""></li>
                <li><img src="{PPPBF}/img/gallery/r8.jpg" alt=""></li>
              </ul>
            </div>
          </div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
  ...
  <script src="{PPPBF}/js/main.js"></script>
</body>
</html>
  """

    with open(os.path.join(os.getcwd() +os.sep+ productHTMLs_folder,
...
try:
    ...
    base_folder =  config.get("DEFAULT", "base_folder")
    image_folder =  config.get("DEFAULT", "images_location")
    catalog = config.get("DEFAULT", "tablename")
    vendors_folder =  config.get("DEFAULT", "vendors")
    productHTMLs_folder = config.get("DEFAULT", "product_folder")
    relPPP = config.get("DEFAULT","relPPP")
    relIMG = config.get("DEFAULT","relIMG")
    pastePointer = config.get("DEFAULT", "pastePointer")
    PPPrelIMG = config.get("DEFAULT","PPPrelIMG")
    PPPBF = config.get("DEFAULT","PPPBF")
    PPPVEN = config.get("DEFAULT","PPPVEN")
    print(host)
    print(dbname)
    print(login)
    print(password)
            ...
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              ...
              <li class="nav-item active submenu dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                  aria-expanded="false">Магазин</a>
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="./category.html">Категории магазиновy</a></li>
                  <li class="nav-item"><a class="nav-link" href="./single-product.html">Детали продукта</a></li>
                  <li class="nav-item"><a class="nav-link" href="./checkout.html">Оформление</a></li>
              ...
              <li class="nav-item submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="nav-item"><a class="nav-link" href="./single-blog.html">Детали</a></li>
                </ul>
              </li>
              <li class="nav-item submenu dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
